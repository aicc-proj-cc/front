...
//   return (
//     <div className="flex justify-center items-center bg-[#2e3a5c] text-white">
...
//               className="w-full p-3 rounded-lg bg-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring focus:ring-pink-500"
//               required
//             />
//             <input
//               type="text"
