      ...
      <div className="app-main-frame">
        ...
        <div className="app-main-content">
          <Routes>
            ...
            <Route path="/CharacterManager" element={<CharacterManager />} /> {/* 캐릭터 등록 */}
            <Route path="/CharacterSearch" element={<CharacterSearch />} /> {/* 캐릭터 조회 */}
            <Route path="/ChatPage" element={<ChatPage />} /> {/* 채팅 페이지 */}
            <Route path="/AITestPage" element={<AITestPage />} /> {/* 이미지 생성 */}
